...
class Category3 extends MusicBeatState
{
    ...
    private function runSong(song:String)
    {
        ...
        {
            case '1':
				PlayState.SONG = Song.loadFromJson('spookeez-hard', 'spookeez');
            ...
            case '2':
				PlayState.SONG = Song.loadFromJson('south-hard', 'south');
				PlayState.isStoryMode = false;
				PlayState.storyDifficulty = 2;
				PlayState.storyWeek = 1;
				FlxG.camera.fade(FlxColor.WHITE, 0.5, false);
				...
				LoadingState.loadAndSwitchState(new PlayState());
            case '3':
				PlayState.SONG = Song.loadFromJson('monster-hard', 'monster');
				PlayState.isStoryMode = false;
				PlayState.storyDifficulty = 2;
				PlayState.storyWeek = 1;
				FlxG.camera.fade(FlxColor.WHITE, 0.5, false);
